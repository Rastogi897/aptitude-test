        ...
        list: [
            {
                ...
                metadata: {
                    ...
                    testimonialFrom:
                        "Linda Jonson, AWS Architect at Prima Solutions",
                    whyCertification: [
        ...
        list: [
            {
                ...
                metadata: {
                    ...
                    testimonialFrom:
                        "John Smith, Senior Developer, Acme Corporation",
                    whyCertification: [
        ...
        list: [
            {
                ...
                metadata: {
                    ...
                    testimonialFrom:
                        "Ibabew, Senior Data Analyst, Zeineth Company",
                    whyCertification: [
        ...
        list: [
            {
                ...
                metadata: {
                    ...
                    testimonialFrom:
                        "John, Automation Developer, Sprints Technologies",
                    whyCertification: [
